...
//other
global.owner = ['94717168986'] // Owner number , (අයිතිකරුගේ නම්බර් එක )
global.pemilik = ['94717168986'] //Change  it , ඔබට කැමති නම් වෙනස් කරන්න
global.premium = ['94717168986'] //Change it ඔබට කැමතිනම් වෙනස් කරන්න 
global.pengguna = '🔥 Yasandu Damhiru 🔥' // Your name ඔබේ නම 
global.botnma = '💃 𝐐𝐮𝐞𝐞𝐧 𝐄𝐥𝐢𝐬𝐚 𝐁𝐨𝐭 💃' // Your bot name , ඔබගෙ බොට්ගේ නම 
global.ownernma = '🔥 Yasandu Damhiru 🔥' //ownernama,ownername
global.packname = 'Queen Elisa Sticker' // Sticker package name 
global.author = 'Dark Maker' // Sticker Autor name 
global.sessionName = 'session'
global.prefa = ['#','!','/',''] 
global.sp = '👋 Hi! I am online now.

🤖 I  am Queen Elisa, an user bot for whatsapp.
...
// Caption 
global.cap = `🔊 Genarated by 🐼Bad Hacker🐼`
global.mess = {
    success: '✅ Done!',
